...
export const PROMPT_TOOLKIT_COMMANDS: SlashCommand[] = [
  ...
  { name: '/reproduce', description: 'Antri BugTwin: Autonomous minimal red test reproduction & interactive visual fix verification' },
  { name: '/replay', description: 'Antri CrashZero: Autonomous incident replay & scrubbable time-travel variable debugger' },
  { name: '/fix', description: 'Automatically diagnose, reproduce, and repair bugs or failing tests in current project' },
